...
所以很適合拿來練習剖析HTML資料。這個作業將用到其中的[Software Products](http://info.cern.ch/hypertext/WWW/Status.html)頁面。
為避免造成對方伺服器的多餘負擔，請您將該網頁下載到自己的電腦裡，並從電腦裡的檔案完成以下問題。
...
網頁剖析的目的，是將網頁的訊息整理成結構化資料，以方便後續的分析。這個[網頁]
(https://raw.githubusercontent.com/RLadsNTU/RLadsLab/master/W10_CrawlAway/data/threadless_access_20171114.html)
是一個國外的購物網站，請以它為材料，整理出這個頁面中的產品資料。
