...
請下載[檔案](https://github.com/RLadsNTU/RLadsLab/blob/master/W7_CorpusAlive/friends_episodes.txt)，包含六人行共236集的標題名稱。並用課堂上所講到的方法，把每個標題當成一個文件，
用tm製作一個六人形影集標題語料庫。
...
請在這個[連結](https://github.com/RLadsNTU/RLadsLab/blob/master/W7_CorpusAlive/president_20171010.txt)下載國慶文告文字檔。並請用課堂上的方法，用內建辭典，幫這個文字檔斷詞，並製作出詞頻表。
